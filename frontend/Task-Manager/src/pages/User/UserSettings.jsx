  ...
  return (
    <DashboardLayout>
      <div className='max-w-4xl mx-auto p-6'>
        ...
        <p className='text-sm text-gray-600 dark:text-gray-400 mb-8'>Manage your account preferences and security</p>
        ...
        <div className='bg-white dark:bg-gray-900 rounded-lg shadow-md dark:shadow-gray-900/50 p-6 mb-6 border border-gray-200 dark:border-gray-800'>
          ...
          <div className='space-y-4'>
            {isEditMode ? (
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <input
                    ...
                    className='w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary bg-white dark:bg-gray-800 text-gray-900 dark:text-white'
              ...
              <div className='flex items-center'>
                <div className='w-24 h-24 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-700 mr-6'>
        ...
        <div className='bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6'>
          ...
          <div className='space-y-3'>
            <p className='text-sm text-red-700 dark:text-red-400 font-medium'>Delete Account</p>
